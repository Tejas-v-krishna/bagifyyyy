  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-6 max-w-2xl mx-auto">
      ...
      <div className="flex flex-col gap-2">
        ...
        <select name="category" className="border border-border p-3 bg-transparent font-medium uppercase text-xs tracking-widest">
      ...
      <div className="flex items-center gap-3">
        ...
        <label htmlFor="isNew" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Mark as New Arrival</label>
      </div>

      <button 
        type="submit" 
        disabled={loading}
        className="btn-bagify py-4 rounded-none uppercase font-bold tracking-widest disabled:opacity-50"
      >
