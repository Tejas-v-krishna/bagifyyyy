    ...
    <div className="bg-y2k-ice min-h-[75vh] flex items-center justify-center px-4 py-16 text-y2k-gunmetal font-sans">
      <div className="w-full max-w-md bg-white border border-y2k-gunmetal/15 p-6 sm:p-10 text-center shadow-md">
        ...
        <p className="text-xs text-y2k-gunmetal/70 leading-relaxed mb-6">
          A temporary error occurred while rendering this page session. You can retry the request or return to active drops.
        </p>

        <div className="flex flex-col gap-2.5">
          <button
            onClick={() => reset()}
            className="btn-bagify w-full py-3.5 text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-2 shadow-xs cursor-pointer"
          >
